...
public class SimpleMenu implements Menu {
    ...
    public boolean add(String parentName, String childName,
        ...
        if (parentName == null) {
            ...
            if (item.isPresent()) {
                SimpleMenuItem simpleMenuItem = (SimpleMenuItem) item.get().menuItem;
                MenuItem menuItem = new SimpleMenuItem(childName, actionDelegate);
                simpleMenuItem.children.add(menuItem);
                rsl = true;
            }
        }
        return rsl;
    ...
    public Optional<MenuItemInfo> select(String itemName) {
        ...
        if (optionalItem.isPresent()) {
            ItemInfo itemInfo = optionalItem.get();
            optional = Optional.of(new Menu.MenuItemInfo(
    ...
    private Optional<ItemInfo> findItem(String name) {
        Optional<ItemInfo> optional = null;
    ...
    private class DFSIterator implements Iterator<ItemInfo> {
        ...
        public ItemInfo next() {
            ...
            for (var i =
                 children.listIterator(children.size()); i.hasPrevious();) {
